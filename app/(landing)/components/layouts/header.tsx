    ...
    <header className="w-full bg-white sticky top-0 z-50 shadow-sm">
      <div className="flex justify-between items-center container mx-auto py-4 px-5 md:py-7">
        ...
        <div className="w-24 md:w-auto">
          <Image src="/images/logo.svg" alt="Sport on" width={127} height={30} className="w-full h-auto" />
        </div>

        {/* NAVIGASI DESKTOP (Hidden di HP) */}
        <nav className="hidden md:flex md:gap-10 lg:gap-44 font-medium transition-all">
          <Link href="#" className="relative hover:text-primary transition-colors">Home</Link>
          <Link href="#" className="hover:text-primary transition-colors">Category</Link>
          <Link href="#" className="hover:text-primary transition-colors">Explore Product</Link>
        </nav>
