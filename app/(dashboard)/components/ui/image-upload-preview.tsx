  ...
  return (
    <div className={className}>
      <div
        ...
        className="relative border-2 border-dashed border-primary bg-primary/5 rounded-lg h-48 w-full flex flex-col justify-center items-center overflow-hidden cursor-pointer"
      >
        {value ? (
