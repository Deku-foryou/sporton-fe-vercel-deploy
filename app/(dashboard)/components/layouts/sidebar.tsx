...
const Sidebar = () => {
  ...
  return (
    <aside className="w-80 min-screen bg-white border-r border-gray-100 flex flex-col fixed left-0 top-0">
      ...
      <button
        className="flex cursor-pointer gap-3 font-medium py-3 px-4.5 mx-5 hover:bg-gray-100 duration-300 rounded-lg mt-40 mb-10"
